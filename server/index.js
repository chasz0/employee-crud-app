...
// ==========================================
// DEPARTMENTS & ROLES (For Frontend Dropdowns)
// ==========================================
...
app.post('/api/employees', async (req, res) => {
  ...
  try {
    ...
    // Insert Dynamic Socials (1-to-Many)
...
app.delete('/api/employees/:id', async (req, res) => {
  try {
    const { id } = req.params;
    // Because we used ON DELETE CASCADE in SQL, deleting the employee 
    // automatically deletes their profile and socials!
